...
| `deprecated`      | (Optional) Object describing a wrap that is no longer maintained.  If there's a replacement wrap, the `replacement` field names it, otherwise the `reason` field explains why the wrap is unmaintained. |
